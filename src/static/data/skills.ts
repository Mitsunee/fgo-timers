...
export const filePath = path.join(
  process.cwd(),
  "assets/static/data/skills.json"
);
export const File = new BundleFile<PartialDataMap<BundledSkill>>(filePath);

/**
 * Reads Skills data bundle
 * @returns Bundled data
 */
export const getSkillsFull = File.readFile.bind(File);
 ...
 */
export const writeBundledSkils = File.writeFile.bind(File);
